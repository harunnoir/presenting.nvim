...
It is rewrite of
https://github.com/harunnoir/presenting.vim/[`presenting.vim`] in lua. It
...
https://github.com/harunnoir/presenting.nvim/blob/main/doc/presenting.txt[documentation].
